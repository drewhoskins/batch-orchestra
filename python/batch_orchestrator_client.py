...
class BatchOrchestratorHandle:
    ...
    async def result(
        ...
        rpc_timeout: Optional[timedelta] = None) -> BatchOrchestratorProgress:
        return await self._handle.result(follow_runs=True, rpc_metadata=rpc_metadata, rpc_timeout=rpc_timeout)
